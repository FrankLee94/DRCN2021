...
class Embedding:
	def __init__(self):
		...
		self.CPU_CAPA = 500			# 单节点CPU容量
		self.RAM_CAPA = 500			# 单节点RAM容量
	...
	def var_based_recover(self):
		fail_cr_sorted = self.sort_fail_cpu_var()
		node_cr_sorted = self.sort_node_cpu_var()
		self.temp_init_var()
