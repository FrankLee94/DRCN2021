...
class Embedding:
	def __init__(self):
		...
		self.arr_rate = 900			# 到达率100
		self.ser_rate = 1			# 服务率
		self.CPU_CAPA = 12*60		# 单节点CPU容量
		self.RAM_CAPA = 64*60		# 单节点RAM容量
		self.WAVE_NUM = 120			# 链路波长数
		# self.traff_df = None		# 储存一次模拟的业务信息
		self.traff_df = pd.read_excel('./traffic/traffic_10000_erlang900.xlsx')
...
if __name__ == '__main__':
	...
	emb.read_topo_file()
	emb.topo_init()
# emb.traff_df.to_excel('./traffic/traffic_10000_erlang700.xlsx', index = False)
